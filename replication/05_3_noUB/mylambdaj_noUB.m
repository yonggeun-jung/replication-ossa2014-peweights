...
%--------------------------------
function [LAMBDAj MFNOPTIMALTARIFFj]=mylambdaj_noUB(j,TARGETTARIFFj)
...
PROHIBj=(TARGETTARIFFj>10);    % practically no upper bound
UB=max(TARGETTARIFFj+0.03,10); %Slightly larger bound than prohibitive TARGETTARIFFj to ensure that boundary LAMBDAj is computed
%Initializing guess
