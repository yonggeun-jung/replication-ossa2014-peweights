function [LAMBDAj, MFNOPTIMALTARIFFj, HISTORY] = mylambdaj_hist(j, TARGETTARIFFj)
...
UB = max(TARGETTARIFFj + 0.03, 2.25);
...
while (TEST == -1 && ITER < MAXITER)
    ...
    elseif ITER >= 10
        ...
        if j == 5
            MFNOPTIMALTARIFFGUESSj = TARGETTARIFFj;
        end
    end
